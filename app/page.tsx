      ...
      <div className="border-b border-border relative overflow-hidden">
        <div className="mx-auto max-w-6xl px-4 pt-16 pb-14 relative">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            ...
            <DarkButton href="/downloads">Get the app</DarkButton>
          </div>
          <div className="mt-3 text-xs text-text/60">Press ⌘K / Ctrl+K to open the overlay anywhere.</div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-6xl px-4 pt-6 pb-10">
        <div className="rounded-2xl p-4 border border-border frosted flex items-center justify-between gap-3">
          <div className="text-sm text-text/80">
            New: <strong>Whisper</strong>, <strong>Smart Tasks</strong>, <strong>Recap</strong>, <strong>Memory</strong>, and <strong>Emotion</strong> tools in the overlay.
          </div>
          <a href="/demo" className="inline-flex items-center justify-center rounded-pill px-4 py-2 border border-border hover:bg-white/60 text-sm">
            Try overlay
          </a>
        </div>
      </div>
